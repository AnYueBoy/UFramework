...
namespace UFramework
{
    public static class CommonUtil
    {
        ...
        private static void merge(List<double> array, int l, int mid, int r)
        {
            ...
            {
                temp[index++] = array[leftPointer] <= array[rightPointer]
                    ? array[leftPointer++]
                    : array[rightPointer++];
            }
        ...
        public static string GetCurPlatformName()
        {
            ...
            switch (runtimePlatform)
            {
                ...
                case RuntimePlatform.WindowsEditor:
                    Debug.LogWarning("curPlatform Windows Editor default use windows");
                    return "Windows";
        ...
        {
            return Mathf.Abs(a - b) <= fuzzyValue;
        }

        public static bool FuzzyEquals(int a, int b, int fuzzyValue)
        {
            return Mathf.Abs(a - b) <= fuzzyValue;
        }
    }
